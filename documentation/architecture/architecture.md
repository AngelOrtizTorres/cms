...
- [Arquitectura Limpia (Por capas)](#arquitectura-limpia-por-capas)
  - [**Dominio**](#dominio)
  - [**Aplicación**](#aplicación)
  - [**Infraestructura**](#infraestructura)
  - [**Interfaz**](#interfaz)
  - [Imágen de la Arquitectura Limpia en el contexto de un CMS:](#imágen-de-la-arquitectura-limpia-en-el-contexto-de-un-cms)
- [Arquitectura Hexagonal (Ports and Adapters)](#arquitectura-hexagonal-ports-and-adapters)
  - [**Núcleo**](#núcleo)
  - [**Puertos**](#puertos)
  - [**Adaptadores**](#adaptadores)
  - [Imágen de la Arquitectura Hexagonal en el contexto de un CMS:](#imágen-de-la-arquitectura-hexagonal-en-el-contexto-de-un-cms)
- [Arquitectura elegida para el CMS](#arquitectura-elegida-para-el-cms)
- [Stack tecnológico para la implementación de la Arquitectura Hexagonal:](#stack-tecnológico-para-la-implementación-de-la-arquitectura-hexagonal)
- [Partes de la arquitectura elegida con el Stack:](#partes-de-la-arquitectura-elegida-con-el-stack)
- [**1. Núcleo del dominio (Laravel)**](#1-núcleo-del-dominio-laravel)
...
- [**3. Adaptadores (Adapters)**](#3-adaptadores-adapters)
  - [Adaptadores de salida:](#adaptadores-de-salida)
  - [Adaptadores de entrada:](#adaptadores-de-entrada)
- [**4. Next.js como BFF**](#4-nextjs-como-bff)
- [Responsabilidades:](#responsabilidades)
- [**5. React como capa de presentación**](#5-react-como-capa-de-presentación)
- [**6. Rol de MariaDB**](#6-rol-de-mariadb)
- [**7. Principios de implementación**](#7-principios-de-implementación)
