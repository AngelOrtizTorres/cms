...
class ArticleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Article::create([
            ...
            'featured' => true,
            'status' => 'published',
            'primary_section_id' => $sections->first()?->id ?? 1,
            'user_id' => $user->id,
        ...
        Article::create([
            ...
            'featured' => true,
            'status' => 'published',
            'primary_section_id' => $sections->where('slug', 'tutoriales')->first()?->id ?? 2,
            'user_id' => $user->id,
        ...
        Article::create([
            ...
            'featured' => false,
            'status' => 'published',
            'primary_section_id' => $sections->where('slug', 'blog')->first()?->id ?? 3,
            'user_id' => $user->id,
