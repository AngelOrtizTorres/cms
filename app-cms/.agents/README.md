...
1 noticia puede pertenecer a muchas secciones pero siempre tienen una principañ.

En la portada del dashboard poner las noticias que quieras (API) Ya sean noticias concretas o el nº de secciones que haya.

Implementar drag and drop para ordenar las secciones y las noticias dentro de cada sección, pero solo para el autor que es el creador de la sección. El admin no puede ordenar las secciones ni las noticias, pero sí puede editarlas y eliminarlas.

El administrador tendra tambien acceso a las webs pero solo podra entrar a aquellas que haya creado el mismo, pero si podra editar y eliminar cualquier web desde la lista de webs.

El autor solo podrá entrar a las webs que haya creado el mismo, pero si podrá crear nuevas webs. El autor no podrá editar ni eliminar ninguna web, pero si las suyas propias, ademas si otro usuario le da permiso en su web este podra entrar pero no podra editar ni eliminar.

El editor en cambio solo podra acceder a las webs que se le hayan dado permisos, pero no podra crear nuevas webs ni editar ni eliminar ninguna web, solo podrá gestionar el contenido de las webs a las que tenga acceso.
