...
export default function CustomizePage() {
  ...
  if (loading) return <p>Cargando personalizador...</p>;
  if (!site) return <p>Site no encontrado</p>;

  return (
    <div>
      <h1 className="text-2xl font-bold">Personalizar: {site.name}</h1>
      <p className="mt-4">Aquí puedes añadir controles para cambiar apariencia, header, footer, colores, etc.</p>
    </div>
  );
}
