...
export default function MediaPage() {
  ...
  if (loading) return <p>Cargando medios...</p>;
  if (!site) return <p>Site no encontrado</p>;

  return (
    <div>
      <h1 className="text-2xl font-bold">Medios: {site.name}</h1>
      <p className="mt-4">Subir y gestionar imágenes, archivos y la biblioteca multimedia.</p>
    </div>
  );
}
