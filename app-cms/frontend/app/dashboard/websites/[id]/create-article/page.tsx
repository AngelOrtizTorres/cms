...
export default function CreateArticlePage() {
  ...
  if (loading) return <p>Cargando creador de artículo...</p>;
  if (!site) return <p>Site no encontrado</p>;

  return (
    <div>
      <h1 className="text-2xl font-bold">Crear artículo en {site.name}</h1>
      <p className="mt-4">Formulario para crear artículo (placeholder).</p>
    </div>
  );
}
